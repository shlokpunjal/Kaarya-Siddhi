...
const ROLE_CONFIG = {
    admin: {
        title: "Admin Login",
        subheading: "Login to your workspace",
        signupRoute: "/(auth)/AdminSignup",
        signupLabel: "Create Admin Account",
    },
    employee: {
        title: "Employee Login",
        subheading: "Login to your workspace",
        signupRoute: "/(auth)/EmployeeSignup",
        signupLabel: "Create Employee Account",
    },
} as const;
    ...
    const sendOTP = async () => {
        ...
        try {
            ...
            const loginResponse = await fetch(`${API_BASE_URL}/login`, {
                ...
                body: JSON.stringify({ email, phone: ph, role }),
            });
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.mainbar}>
                <BackButton />
                <Text style={[styles.maintext, typography.heading]}>{config.title}</Text>
            </View>
                ...
                >
                    <View style={styles.mainStyle}>
                        ...
                        <View
                            style={[
                                styles.divi,
                                (isOnCooldown || errors.phone || errors.email) && styles.diviExpanded,
                            ]}
                        >
                            ...
                            {isOnCooldown && (
                                <Text style={styles.resendText}>Resend in : {cooldown}.00 secs</Text>
                            )}
                        </View>
                        ...
                        <View style={styles.SetStyle}>
                            <Text
                                onPress={() => router.push(config.signupRoute)}
...
const styles = StyleSheet.create({
    ...
    setText: { color: "white", fontSize: 15, fontFamily: "Poppins_600SemiBold" },
    SetStyle: {
        alignItems: "center",
    ...
    LoginDisabled: { backgroundColor: "#6B7280", shadowOpacity: 0, elevation: 0 },
    mainStyle: { alignItems: "center", justifyContent: "center" },
    mainbar: { backgroundColor: "#1A2744", padding: wp(5.3) },
    maintext: {
        color: "white",
        fontSize: 20,
        fontFamily: "Poppins_400Regular",
    ...
    diviExpanded: { paddingBottom: 28 },
    divtext: { fontSize: 18, color: "#1A2744", fontFamily: "Poppins_400Regular" },
    resendText: {
        marginTop: 20,
        color: "#E8870A",
        fontSize: 13,
