...
export default function Dashboard() {
  ...
  // ── Bell badge: count of admin-decided requests, refreshed on focus ────── (UNCHANGED)
  useFocusEffect(
    useCallback(() => {
      (async () => {
        const email = await AsyncStorage.getItem('userEmail');
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
        ...
        <View>
          <View style={{
            ...
            {/* Bell icon — ONLY CHANGE: navigation target + red dot instead of numbered badge */}
            <TouchableOpacity
            ...
            >
              ...
              {decidedRequestCount > 0 && (
                <View style={{
                  ...
                  borderWidth: 2,
                  borderColor: colors.base.surfaceL2,
                }} />
              )}
            </TouchableOpacity>
          </View>
