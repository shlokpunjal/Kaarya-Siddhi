...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const checkUserAndFetchTasks = async () => {
      ...
      // This app authenticates via a custom OTP backend (see hooks/useAuth.ts),
      // NOT Supabase Auth — so the session lives in AsyncStorage.
      ...
      // assigned_to stores the employee's email (text), not a UUID
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.base.background }}>
      <ScrollView contentContainerStyle={{ paddingBottom: 20 }}>
        ...
        {/* Header Block */}
        <View>
          <Text style={{ ...typography.subheading, marginTop: 20, marginLeft: 15, color: colors.text.secondary }}>Good Morning!</Text>
          <Text style={{ ...typography.heading, marginTop: 5, marginLeft: 15, color: colors.text.primary }}>Your Task Overview</Text>

          {/* Metrics Matrix Container */}
          <View style={{
            backgroundColor: "#FFFFFF", marginTop: 25, margin: 20, height: 140, borderRadius: 25,
            flexDirection: "row", alignItems: "center", justifyContent: "space-around",
            borderColor: "#E2E2E6", borderWidth: 2.5
          }}>
            {/* Overdue */}
        ...
        {/* ---- Overdue Dropdown Accordion Section ---- */}
        <View style={{ width: 320, marginTop: 30, marginLeft: 33, borderColor: colors.base.border, borderWidth: 1, borderRadius: 19, backgroundColor: "#FFFFFF" }}>
          ...
          {showOverdue && (
            <View style={{ borderRadius: 15, marginTop: 5 }}>
              {overdueTasks.map((task) => (
                <TouchableOpacity key={task.id} onPress={() => router.push({ pathname: '/(task)/task-detail', params: { taskId: task.id } })} style={{ flexDirection: "row", alignItems: "center", backgroundColor: colors.base.surfaceL2, borderRadius: 12, padding: 12, marginBottom: 8, gap: 12, borderColor: colors.base.border, borderWidth: 1, margin: 10 }}>
        ...
        {/* ---- Pending Dropdown Accordion Section ---- */}
        ...
        {/* ---- In Review Dropdown Accordion Section ---- */}
        <View style={{ width: 320, marginTop: 20, marginLeft: 33, borderColor: colors.base.border, borderWidth: 1, borderRadius: 19, backgroundColor: colors.base.surfaceL1 }}>
          <View style={{ height: 60, borderRadius: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 20 }}>
        ...
        {/* ---- Completed Dropdown Accordion Section ---- */}
        <View style={{ width: 320, marginTop: 20, marginLeft: 33, borderColor: colors.base.border, borderWidth: 1, borderRadius: 19, backgroundColor: colors.base.surfaceL1 }}>
          <View style={{ height: 60, borderRadius: 20, flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 20 }}>
