...
// All Realtime subscription setup, push-token registration, and
// notification-tap navigation now live in hooks/useNotificationBridge.ts
// (+ services/notificationService.ts, services/realtimeService.ts). This
// component just mounts the hook so _layout.tsx stays focused on
